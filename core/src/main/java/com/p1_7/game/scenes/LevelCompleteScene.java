...
public class LevelCompleteScene extends Scene {
    ...
    public void onEnter(SceneContext context) {
        ...
        title = new StaticLabel("LEVEL " + currentLevel + " COMPLETE!", cx, cy + 120f, titleFont);
        promptStatus = new StaticLabel("Next up: Level " + nextLevel, cx, cy + 55f, promptFont);
        ...
        hintSpace = new StaticLabel(spaceHint, cx, cy - 175f, promptFont);
